app.controller("AuthorCtrl", ['$scope', '$sce', '$modalInstance', 'showAuthor',  function($scope, $sce, $modalInstance, showAuthor){
    ...
    var htmlPlayer = '<iframe width="100%" height="120" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/' + $scope.author.book_report_link + '&amp;color=d9eded&amp;inverse=false&amp;auto_play=false&amp;show_user=false&amp;show_artwork=false"></iframe>'
