app.controller("StoryCtrl", ['$scope', '$modalInstance', 'showStory', '$sce',  function($scope, $modalInstance, showStory, $sce){
    ...
    var htmlPlayer = '<iframe width="100%" height="120" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/' + showStory.audio + '&amp;color=d9eded&amp;inverse=false&amp;auto_play=false&amp;show_user=false&amp;show_artwork=false"></iframe>'
