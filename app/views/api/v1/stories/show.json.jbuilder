json.(@story, :title, :headline, :related_author, :litographer, :feature_image, :has_header, :text, :published, :audio, :published_at, :visual, :audio, :writing, :multimedia, :book_report, :id)
